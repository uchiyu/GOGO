...
public class SetPlayer
{
  ...
  public SetPlayer()
  {
    ...
    //player1.set_comp(new data.strategy.user.s13t208.User_s13t208_01(player1));

    //player1.set_comp(new data.strategy.user.s11t200.User_s11t200_00(player1));
    player1.set_comp(new data.strategy.user.s13t208.User_s13t208_01(player1));
    //player1.set_comp(new data.strategy.user.s13t208.User_s13t208_02(player1));
    ...
    //player2.set_comp(new data.strategy.user.s13t208.User_s13t208_01(player2));
